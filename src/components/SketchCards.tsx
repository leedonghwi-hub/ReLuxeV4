...
export const SketchCards: React.FC<SketchCardsProps> = ({
  ...
  return (
    <section className="w-full max-w-[1680px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 py-12 sm:py-20 lg:py-24">
      {/* 섹션 헤더 타이틀 */}
      <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 sm:mb-12 px-2">
        <div>
          <h2 className="font-serif-luxury text-3xl sm:text-4xl lg:text-5xl font-bold text-[#2C2825] flex items-center gap-2">
            <span>카테고리 선택</span>
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-[#7C6F5E] mt-2 sm:mt-3 font-sans-kr">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
        {categories.map((item) => {
          ...
          return (
            ...
            >
              {/* 일러스트 아이콘 박스 */}
              <div className="py-10 sm:py-14 px-5 flex-1 flex flex-col items-center justify-center text-center">
                <div
                  className={`w-36 h-36 sm:w-44 sm:h-44 rounded-2xl sm:rounded-3xl flex items-center justify-center p-4 sm:p-5 transition-transform duration-300 group-hover:scale-105 ${
                    isPreparing
                ...
                >
                  {/* 가방 일러스트 아이콘 */}
                  {item.iconType === 'bag' && (
                    <svg viewBox="0 0 100 100" className="w-24 h-24 sm:w-28 sm:h-28 fill-none stroke-current stroke-[2.2] stroke-linecap-round stroke-linejoin-round text-[#2C2825]">
                  ...
                  {item.iconType === 'jewelry' && (
                    <div className="flex flex-col items-center justify-center text-[#B5A492] group-hover:text-[#C5A059] transition-colors">
                      <svg viewBox="0 0 24 24" className="w-14 h-14 sm:w-16 sm:h-16 fill-none stroke-current stroke-[1.5] stroke-linecap-round stroke-linejoin-round mb-1">
                        <circle cx="12" cy="15" r="6" />
                        <path d="M9 3h6l2 4L12 10 7 7 9 3z" />
                        <path d="M7 7h10" />
                        <path d="M12 3v7" />
                      </svg>
                      <span className="font-serif-luxury text-base font-medium">Jewelry</span>
                    </div>
                  )}
                  ...
                  {item.iconType === 'apparel' && (
                    <div className="flex flex-col items-center justify-center text-[#B5A492] group-hover:text-[#C5A059] transition-colors">
                      <svg viewBox="0 0 24 24" className="w-14 h-14 sm:w-16 sm:h-16 fill-none stroke-current stroke-[1.5]">
                        <path d="M20.38 3.46 16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z" />
                      </svg>
                      <span className="font-serif-luxury text-base font-medium">Apparel</span>
                    </div>
                  )}
                  ...
                  {item.iconType === 'shoes' && (
                    <div className="flex flex-col items-center justify-center text-[#B5A492] group-hover:text-[#C5A059] transition-colors">
                      <svg viewBox="0 0 24 24" className="w-14 h-14 sm:w-16 sm:h-16 fill-none stroke-current stroke-[1.5] stroke-linecap-round stroke-linejoin-round">
                      ...
                      <span className="font-serif-luxury text-base font-medium">Shoes</span>
                    </div>
                  )}
                </div>

                {/* 카테고리명 */}
                <h3 className="font-sans-kr text-2xl sm:text-3xl lg:text-4xl font-bold text-[#2C2825] mt-5 group-hover:text-[#1A1816] tracking-tight">
                  {item.title}
                </h3>
                ...
                {isPreparing ? (
                  <div className="mt-2 flex flex-col items-center">
                    <span className="font-brand text-2xl sm:text-3xl lg:text-4xl text-[#9E8E7D] tracking-wide leading-none">
                      preparing
                    </span>
                    <span className="font-sans-kr text-xs sm:text-sm text-[#A89887] font-medium mt-1">
                      (준비중)
                    </span>
                  </div>
                ) : (
                  <span className="text-xs sm:text-sm lg:text-base text-[#8C7D6B] font-sans-kr font-medium mt-2">
